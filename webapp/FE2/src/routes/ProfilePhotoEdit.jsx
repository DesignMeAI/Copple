...
function ProfilePhotoEdit() {
    ...
    useEffect(() => {
        async function fetchUserProfile() {
            try {
                const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiYXJpbiIsImlhdCI6MTY5NTE3Njc1NiwiZXhwIjoxNjk1MjEyNzU2fQ.ZW3qCBzmRZZ8u2kdUPQ9-mxNfee4ETt4h2QUkMM8aZ4";
